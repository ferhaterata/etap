...
@foo = dso_local global %struct.Foo { i32 0, i32 1, %struct.Bar { i32 5, i32 3 } }, align 4
...
entry:
  ...
  store i32 %1, i32* getelementptr inbounds (%struct.Foo, %struct.Foo* @foo, i32 0, i32 0), align 4
  %2 = load i32, i32* getelementptr inbounds (%struct.Foo, %struct.Foo* @foo, i32 0, i32 1), align 4
  ret i32 %2
}
