...
setMethod("+", c("DiscreteDistribution", "DiscreteDistribution"),
          function(e1, e2) {
            message("DiscreteDistribution.setMethod(\"+\", c(\"DiscreteDistribution\",\"DiscreteDistribution\")\n")
...
setMethod("+", c("Dirac", "DiscreteDistribution"),
          function(e1, e2) {
            message("DiscreteDistribution.setMethod(\"+\", c(\"Dirac\",\"DiscreteDistribution\")\n")
            e2 + location(e1) })
...
setMethod("*", c("DiscreteDistribution", "numeric"),
          function(e1, e2) {
            message("DiscreteDistribution.setMethod(\"*\", c(\"DiscreteDistribution\",\"numeric\")\n")
            Distr <- .multm(e1, e2, "DiscreteDistribution")
...
setMethod("+", c("DiscreteDistribution", "numeric"),
          function(e1, e2) {
            message("DiscreteDistribution.setMethod(\"+\", c(\"DiscreteDistribution\",\"numeric\")\n")
            Distr <- .plusm(e1, e2, "DiscreteDistribution")
            if (is(Distr, "AffLinDistribution"))
              Distr@X0 <- e1
...
setMethod("*", c("AffLinDiscreteDistribution", "numeric"),
          function(e1, e2) {
            message("DiscreteDistribution.setMethod(\"*\", c(\"AffLinDiscreteDistribution\",\"numeric\")\n")
