...
forloop_time <- distr::Norm(mean = 2331360588, sd = 46421434) # ns
forloop_energy <- distr::Norm(mean = 3032.68, sd = 60.28) # uj

# energy_trace <- read.csv("experiments/balanced_path_analysis/EnergyTrace_2021_07_26_143411_input128_loop100000.csv", header = TRUE, sep = ",")
# energy_trace <- read.csv("experiments/balanced_path_analysis/EnergyTrace_2021_07_26_145022_input0_loop100000.csv", header = TRUE, sep = ",")
# energy_trace <- read.csv("experiments/balanced_path_analysis/EnergyTrace_2021_07_26_150347_input0_loop1000.csv", header = TRUE, sep = ",")
energy_trace <- read.csv("experiments/balanced_path_analysis/EnergyTrace_2021_07_26_175536._input0_loop100000_10profxml", header = TRUE, sep = ",")
...
print_balanced_path_time <- function() {
  cat("\nTime @ 1 MHz (us)")
  cat("\nMode ", "Mean", "Sd")
...
print_balanced_path_energy <- function() {
  cat("\nEnergy (nj)")
  cat("\nMode ", "Mean", "Sd")
...
print_balanced_path_time()
print_balanced_path_energy()
