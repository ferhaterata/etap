...
entry:
  %nums = alloca [3 x [3 x i64]], align 16
  %i = alloca i64, align 8
  %i1 = alloca i64, align 8
  %0 = bitcast [3 x [3 x i64]]* %nums to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %0, i8* align 16 bitcast ([3 x [3 x i64]]* @__const.index_i2.nums to i8*), i64 72, i1 false)
  store i64 2, i64* %i, align 8
  store i64 1, i64* %i1, align 8
  %1 = load i64, i64* %i, align 8
  %arrayidx = getelementptr inbounds [3 x [3 x i64]], [3 x [3 x i64]]* %nums, i64 0, i64 %1
  %2 = load i64, i64* %i, align 8
  %arrayidx2 = getelementptr inbounds [3 x i64], [3 x i64]* %arrayidx, i64 0, i64 %2
