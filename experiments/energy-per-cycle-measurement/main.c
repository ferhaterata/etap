...
int main(void) {
  ...
  compute();  // 1 cycle in 1 MHz clock => 1us; 1000cycle => 1ms
              // 1 compute 610 mJ; 430 ms = 430000cycle for 1 aes
              // 610mJ / 430000cycle = 0,001418605mJ = 1.42uJ
              // 1.42uJ per 1 cycle (1 aes computation)
  LPM4;

  // Energy in a Capacitor
  // C.V^2 / 2 Farad to Joule Formula
  // for 1000uF capacitor
  //  |_____ 1x10^-3 F x (3.3)^2 / 2 = 5.445 mJ total energy
  //  |_____ 1 cycle 0.00142mJ so 5.445mJ / 0.00142mJ = 3834.507 total cycles
  //  |_____ 1 aes compute = 610mJ so 610mJ / 5.445mJ = 112.03 times
  //         power failures.
  // for 50mF capacitor
  //  |_____ 272.25 mJ total energy
  //  |_____ 1 cycle 0.00142mJ so 272.25mJ / 0.00142mJ = 191725,35 total cycles
  //  |_____ 1 aes compute = 610mJ so 610mJ / 272.25mJ = 2.24 times
  //         power failures.
  return 0;
}
