...
entry:
  ...
  %buf = alloca %struct.S, align 4
  %p = alloca %struct.S*, align 8
  store i32 0, i32* %retval, align 4
  %0 = bitcast %struct.S* %buf to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %0, i8* align 4 bitcast (%struct.S* @__const.main.buf to i8*), i64 8, i1 false)
