...
#include "eh_distribution.h"
#include "pf_distribution.h"
...
void Timer_A0_set() {
  TA0CCR0 = power_failure_simulator.data[index_pf++];
...
#endif
{
  ...
  __delay_cycles(energy_harvester_simulator.data[index_eh++]);
