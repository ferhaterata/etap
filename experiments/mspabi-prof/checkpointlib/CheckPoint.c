...
void restore() {
   ...
   __asm__ __volatile__ ("MOVA  %0, R5"
                          : "=m" (asm_base_addrs_reg) );
   __asm__ __volatile__ (" MOV 60(R5) ,R6");
   __asm__ __volatile__ (" MOV.W 56(R5) ,4(R6)");
   __asm__ __volatile__ (" ADD #0x0C ,R6");
   __asm__ __volatile__ (" MOV.W 52(R5) ,R6");

   __asm__ __volatile__ (" MOV.A 44(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 40(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 36(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 32(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 28(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 24(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 20(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 16(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 12(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 8(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 4(R5) ,R6");
   __asm__ __volatile__ (" MOV.A 2(R5) ,R6");
   __asm__ __volatile__ (" PUSH 56(R5)");
   __asm__ __volatile__ (" MOV.A 48(R5) ,R5");
