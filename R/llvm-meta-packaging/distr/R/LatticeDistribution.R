...
function(e1,e2){
  message("LatticeDistribution.setMethod(\"+\", c(\"LatticeDistribution\",\"LatticeDistribution\")\n")
...
setMethod("+", c("LatticeDistribution", "numeric"),
          function(e1, e2) 
             {
               message("LatticeDistribution.setMethod(\"+\", c(\"LatticeDistribution\",\"numeric\")\n")
...
setMethod("+", c("AffLinLatticeDistribution", "numeric"),
          function(e1, e2) 
             {
               message("LatticeDistribution.setMethod(\"+\", c(\"AffLinLatticeDistribution\",\"numeric\")\n")
               L <- lattice(e1)
              pivot(L) <- pivot(L) + e2
              Symmetry <- NoSymmetry()
              if(is(e1@Symmetry,"SphericalSymmetry"))
