...
static void toggleLED(int BIT);
static void turnOnLED(int BIT);
static void turnOffLED(int BIT);

#define timer_count 32768
static int data_test_counter = 0; // if 4, all tests are passed
...
{
    P1OUT &= ~BIT0;
    __delay_cycles(1000000); // charge time
    P1OUT |= BIT0;
    Reset();
}
