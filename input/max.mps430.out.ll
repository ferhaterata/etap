...
if.end:                                           ; preds = %if.then, %for.body1
  %max.1 = phi i16 [ %2, %if.then ], [ %max.0, %for.body1 ]
  br label %for.inc
...
if.end.i:                                         ; preds = %if.then.i4, %for.body.i5
...
largest.exit:                                     ; preds = %for.cond.i
  ...
  br label %largest.exit6

largest.exit6:                                    ; preds = %largest.exit
