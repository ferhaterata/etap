; ModuleID = 'test/r/input/pointer4.ll'
...
@foo = dso_local global %struct.Foo { i32 0, i32 1, %struct.Bar { i32 5, i32 3, i32* @b } }, align 8, !global !2

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32* @index_first() #0 !store !5 {
entry:
  %0 = load i32*, i32** getelementptr inbounds (%struct.Foo, %struct.Foo* @foo, i32 0, i32 2, i32 2), align 8, !store !6
  ret i32* %0, !store !7
}
