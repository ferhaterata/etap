; ModuleID = 'test/r/input/struct5.ll'
source_filename = "./input/struct5.c"
...
@foo = dso_local global %struct.Foo { i32 0, i32 1, %struct.Bar { i32 2, i32 3 } }, align 4
...
!2 = !{!"entry <- FALSE"}
!3 = !{!"v.0 <- load(gep(ptr(c.foo), 0, 1))"}
!4 = !{!"path.return <<- c(path.return, ret(v.0)); entry <- TRUE"}
