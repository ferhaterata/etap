...
define dso_local i32 @And(i32 %x, i32 %y) #0 !distribution !2 !distribution !3 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Or(i32 %x, i32 %y) #0 !distribution !4 !distribution !5 {
entry:
  %retval = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Not(i32 %x) #0 !distribution !6 {
entry:
  %retval = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @NotEq(double %x) #0 !distribution !7 {
entry:
...
return:                                           ; preds = %if.end, %if.then
  %1 = load double, double* %retval, align 8
  ret double %1
}
...
!2 = !{!"x <- 0"}
!3 = !{!"y <- 2 * 1 + 1"}
!4 = !{!"x <- DiscreteDistribution(0)"}
!5 = !{!"y <- DiscreteDistribution(1)"}
!6 = !{!"x <- DiscreteDistribution(supp = c(1, 0), prob = c(0.4, 0.6))"}
!7 = !{!"x <- Unif(Min=0, Max=1)"}
