...
setMethod("+", c("AbscontDistribution", "AbscontDistribution"),
          function(e1, e2) {
            message("ContDistribution.setMethod(\"+\", c(\"AbscontDistribution\",\"AbscontDistribution\")\n")
            ### Step 1 : Truncation
...
setMethod("*", c("AbscontDistribution", "numeric"),
          function(e1, e2) {
            message("ContDistribution.setMethod(\"*\", c(\"AbscontDistribution\",\"numeric\")\n")
            Distr <- .multm(e1, e2, "AbscontDistribution")
...
setMethod("+", c("AbscontDistribution", "numeric"),
          function(e1, e2) {
            message("ContDistribution.setMethod(\"+\", c(\"AbscontDistribution\",\"numeric\")\n")
            Distr <- .plusm(e1, e2, "AbscontDistribution")
            if (is(Distr, "AffLinDistribution"))
              Distr@X0 <- e1
            if (is(e1@Symmetry, "SphericalSymmetry"))
              Distr@Symmetry <-
...
setMethod("*", c("AffLinAbscontDistribution", "numeric"),
          function(e1, e2) {
            message("ContDistribution.setMethod(\"*\", c(\"AffLinAbscontDistribution\",\"numeric\")\n")
            Distr <- .multm(e1, e2, "AffLinAbscontDistribution")
            if (is(e1@Symmetry, "SphericalSymmetry"))
              Distr@Symmetry <-
                SphericalSymmetry(SymmCenter(e1@Symmetry) * e2)
            Distr })
setMethod("+", c("AffLinAbscontDistribution", "numeric"),
          function(e1, e2) {
            message("ContDistribution.setMethod(\"+\", c(\"AffLinAbscontDistribution\",\"numeric\")\n")
            Distr <- .plusm(e1, e2, "AffLinAbscontDistribution")
            if (is(e1@Symmetry, "SphericalSymmetry"))
              Distr@Symmetry <-
                SphericalSymmetry(SymmCenter(e1@Symmetry) + e2)
            Distr })
